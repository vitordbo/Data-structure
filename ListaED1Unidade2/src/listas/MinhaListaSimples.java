...
public class MinhaListaSimples<T> implements InterfaceListas<T> {
    // lista simplemente encadeada com generics
    ...
    // atributos minha lista
    private Node head;
    private Node tail;
    public int size;

    // construtor minhaLista
    public MinhaListaSimples() {
        head = null;
        tail = null;
        size = 0;
    }
    ...
    public void addFirst(T dado) {
        ...
        // Anexa elemento NOVO
        // comecar atribuindo os atributos null.

        if (head == null) {
            head = novo; // novo sera o primeiro elemento
            tail = novo; // novo sera o último elemento
        } else {
            // Anexa
            novo.next = head;
            head = novo;
